...
students = [
  ...
  { name: '零', surname: '影月', birth_date: Date.new(1982, 1, 1), enrollment_status_code: @enrollment_status },
  { name: 'サニー', surname: 'スノー', birth_date: Date.new(1982, 1, 1), enrollment_status_code: @enrollment_status }
]
